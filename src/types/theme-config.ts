...
// 先获取模式返回类型避免循环引用
type ThemeConfigSchemaType = ReturnType<typeof ThemeConfigSchema>

// 正确导出类型，避免循环引用错误
export type ThemeUserConfig = z.input<ThemeConfigSchemaType>
export type ThemeConfig = z.infer<ThemeConfigSchemaType>
